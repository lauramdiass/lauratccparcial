...
(function ($, moment) {
	...
	Plugin.prototype =
	{
		...
		_onCloseClick: function()
		{
			...
			$(this.$dtpElement).on("animationend mozAnimationEnd oAnimationEnd MSAnimationEnd",
				function(){
						a.hide();
			});
            ...
            if(this.params.animation===true)
            {
                   ...
                   var rippler = $(this.$dtpElement.find(".dtp-date-view-ripple"));
                    ...
                    ink.css({
                      ...
                      $(this.$dtpElement.find(".dtp-date-view-ripple .ink")).on("animationend mozAnimationEnd oAnimationEnd MSAnimationEnd",
                          function(event2){
