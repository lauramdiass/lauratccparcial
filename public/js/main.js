(function (jQuery) {
    ...
    $.fn.carouselAnimate = function()
    {
        ...
        {
          var animEndEv = 'mozAnimationEnd animationend';
    ...
    $("#mimin-mobile-menu-opener").on("click",function(e){
        ...
        if(!rippler.hasClass("reverse"))
        {
            ...
            rippler.animate({
             ...
             $("#mimin-mobile .ink").on("animationend mozAnimationEnd oAnimationEnd MSAnimationEnd",
              function(e){
    ...
    $(".form-text").on("click",function(){
        ...
        $(".ripple-form").on("animationend mozAnimationEnd oAnimationEnd MSAnimationEnd",
          function(e){
              // do something here
              $(this).remove();
           });
